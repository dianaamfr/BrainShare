...
class ReportPolicy
{
    ...
    public function update(User $user, Report $report){
        ...
        return $user->isModerator() && (
            ...
            (!is_null($report->question) && $report->question->user_role == 'RegisteredUser') ||
            (!is_null($report->answer) && $report->answer->user_role == 'RegisteredUser') ||
            (!is_null($report->comment) && $report->comment->user_role == 'RegisteredUser'));
