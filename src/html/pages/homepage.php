    ...
    <div class="mx-3">
        ...
        <div class="row py-5 homepage-feature">
            <div class="offset-md-1 col-md-6 homepage-feature-text">
                ...
                <a href="#" class="btn btn-secondary mb-4">About Us</a>
            </div>
            <div class="col-md-5 homepage-feature-image">
                <svg class="img-fluid mx-auto" width="500" height="300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false">
        ...
        <section class="homepage-lastsearch my-5 d-flex mx-auto flex-column text-center">
            <h2 class="mb-4 fw-normal">Looking for questions to answer?</h2>
