...
function editQuestionForm($courses) { ?>
    <div class="page-margin">
        <section class="background-light container-sm add-question bg-light rounded-1">
            <h2 class="mb-4">Edit Question</h2>
            <form>
                <!-- Question Title -->
                <div class="mb-3">
                    <label for="questionTitle" class="form-label">Question Title*</label>
                    <input type="text" class="form-control" id="questionTitle" value="Should I learn MIPS?" required>
                ...
                <div class="mb-3">
                    ...
                    <input id="questionTagsSelect" type="text" class="form-control" placeholder="Associate Tags here">
                </div>
