...
<nav class="bd-subnavbar align-items-center p-2" aria-label="Secondary navigation">
  <ul class="d-flex m-0 p-0">
    <li class="nav-link nav-item subnav-selected"><a href="{{route('manage-categories')}}">Categories</a></li>
...
<div class="d-flex justify-content-between page-margin categories-content">
    ...
    <aside class="mt-5 col-md-3 col-lg-3 mt-5 d-md-block management-nav">
        <ul>
            <li><a href="{{route('manage-categories')}}" class="blue">Manage Categories</a></li>
                ...
                <table class="table table-hover align-middle w-100">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>300</td>
                            <td>12/01/2020</td>
                            <td><span class="icon-hover" title="Delete">
                                <button class="p-0"><i class="far fa-trash-alt"></i></button> 
                                <button class="p-0"><i class="fas fa-trash-alt"></i></button> 
                            </span></td>
                        </tr>
