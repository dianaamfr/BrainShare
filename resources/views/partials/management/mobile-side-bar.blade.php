...
<nav class="bd-subnavbar align-items-center p-2" aria-label="Secondary navigation">
    <ul class="d-flex m-0 p-0">
      ...
      <li class="nav-link nav-item {{ Request::is('admin/categories/tags') || Request::is('admin/categories/courses') ? 'subnav-selected' : ''}}"><a href="{{route('manage-tags')}}">Categories</a></li>
